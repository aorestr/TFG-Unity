...
Aunque al comienzo el propósito del proyecto era desarrollar algo similar a lo descrito en la subsección \ref{subsec:modelojuego}, en la subsección siguiente, la \ref{subsec:fracasojuego}, ya hablamos del juego a desarrollar. Propusimos entonces crear un pequeño nivel como prueba de concepto para así demostrar el potencial entre la biblioteca, el simulador y el motor de juego.
...
\begin{itemize}
\item El fondo es una imagen estática tomada de OpenGameArt, una famosa web que publica arte redistribuible para la elaboración de juegos. Está liberado bajo una licencia	\href{https://creativecommons.org/licenses/by/3.0/}{CreativeCommons 3.0} con retribución, lo que implica que puede ser compartido y copiado siempre y cuando se dé crédito al autor y una referencia al material. Un enlace desde donde puede ser encontrado ya se ha dejado en la línea anterior. Gracias a ``Alucard'' por esta imagen. El diseño puede ser consultado en la dirección \url{https://opengameart.org/content/industrial-background-2d}.
\item El decorado del nivel se ha generado gracias a un conjunto de sprites localizados una vez más en OpenGameArt. En esta ocasión, el material tiene licencia \href{https://creativecommons.org/publicdomain/zero/1.0/}{CC0 1.0}, de dominio público; totalmente libre. El diseño puede ser consultado en la dirección \url{https://opengameart.org/content/sci-fi-platform-tiles}.
...
\item Finalmente, nos hemos visto ayudados por uno de los paquetes que Unity incluye por defecto. Se trata del paquete ``2D'', que puede ser descargado desde el propio cliente de Unity en \textit{Assets} $\rightarrow$ \textit{Import package} $\rightarrow$ \textit{2D}. Incluye una serie de assets básicos para la creación de niveles bidimensionales. 
