...
Aunque al comienzo el propósito del proyecto era desarrollar algo similar a lo descrito en la subsección \ref{subsec:modelojuego}, la complejidad que existente para llevarlo a cabo era demasiado grande. En su lugar, se ha preferido crear un único pequeño nivel que sirva como demostración del potencial del proyecto.
...
Con este juego tan sencillo conseguimos dos cosas:
\begin{itemize}
